...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.google.com https://www.gstatic.com https://*.googletagmanager.com https://calendar.google.com https://accounts.google.com https://connect.facebook.net",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: blob: https://images.unsplash.com https://cdn.prod.website-files.com https://www.facebook.com",
      "connect-src 'self' https://crm.zoho.in https://crm.zoho.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://calendar.google.com https://accounts.google.com https://www.facebook.com https://connect.facebook.net",
      `frame-src https://www.google.com https://recaptcha.google.com https://calendar.google.com ${PORTFOLIO_FRAME_ORIGINS}`,
      "object-src 'none'",
      "base-uri 'self'",
