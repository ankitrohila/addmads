...
const SERVICE_DATA: Record<string, {
  ...
  'performance-marketing': {
    ...
    coverflow: [
      { title: 'Google Ads & PPC', description: 'Search, shopping, and display ads that capture buyers at the right moment.', tag: 'Search', href: '/services/performance-marketing/google-ads', img: 'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?w=600&h=400&fit=crop&q=80' },
      { title: 'Meta / Facebook Ads', description: 'Target your ideal customer on Facebook and Instagram with precision.', tag: 'Social', href: '/services/performance-marketing/meta-ads', img: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=600&h=400&fit=crop&q=80' },
      { title: 'Social Media Marketing', description: 'Organic and paid social strategies that build and convert audiences.', tag: 'Organic+Paid', href: '/services/performance-marketing/social-media', img: 'https://images.unsplash.com/photo-1562577309-4932fdd64cd1?w=600&h=400&fit=crop&q=80' },
      { title: 'Email Marketing', description: 'Automated sequences and campaigns that nurture leads and drive repeat sales.', tag: 'Email', href: '/services/performance-marketing/email-marketing', img: 'https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=600&h=400&fit=crop&q=80' },
      { title: 'Content Marketing', description: 'SEO content and thought leadership that builds long-term authority.', tag: 'Content', href: '/services/performance-marketing/content-marketing', img: 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=600&h=400&fit=crop&q=80' },
      { title: 'Influencer Marketing', description: 'Authentic creator partnerships that drive awareness and conversions.', tag: 'Influencer', href: '/services/performance-marketing/influencer', img: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=600&h=400&fit=crop&q=80' },
    ],
    faqs: [
  ...
  'branding': {
    ...
    coverflow: [
      { title: 'Brand Strategy', description: 'Market positioning and brand architecture for long-term success.', tag: 'Strategy', href: '/services/branding/brand-strategy', img: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=560&h=340&fit=crop&q=80' },
      { title: 'Logo Design', description: 'Timeless, versatile logos that work everywhere.', tag: 'Logo', href: '/services/branding/logo-design', img: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=560&h=340&fit=crop&q=80' },
      { title: 'Visual Identity', description: 'Complete visual system — colours, fonts, imagery style.', tag: 'Identity', href: '/services/branding/visual-identity', img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=560&h=340&fit=crop&q=80' },
      { title: 'Brand Guidelines', description: 'Comprehensive brand book for consistent application.', tag: 'Guidelines', href: '/services/branding/brand-guidelines', img: 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=560&h=340&fit=crop&q=80' },
      { title: 'Brand Voice', description: 'Tone of voice and messaging that resonates with your audience.', tag: 'Voice', href: '/services/branding/brand-voice', img: 'https://images.unsplash.com/photo-1455390582262-044cdead277a?w=560&h=340&fit=crop&q=80' },
      { title: 'Packaging Design', description: 'Product packaging that converts at the shelf and online.', tag: 'Packaging', href: '/services/branding/packaging', img: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=560&h=340&fit=crop&q=80' },
    ],
    faqs: [
  ...
  'seo': {
    ...
    coverflow: [
      { title: 'Technical SEO', description: 'Fix the foundation — speed, structure, and crawlability.', tag: 'Technical', href: '/services/seo/technical-seo', img: 'https://images.unsplash.com/photo-1547658719-da2b51169166?w=560&h=340&fit=crop&q=80' },
      { title: 'On-Page SEO', description: 'Keyword-rich content and metadata that ranks.', tag: 'On-Page', href: '/services/seo/on-page', img: 'https://images.unsplash.com/photo-1542435503-956c469947f6?w=560&h=340&fit=crop&q=80' },
      { title: 'Off-Page & Links', description: 'Authority-building backlinks from real, relevant sources.', tag: 'Off-Page', href: '/services/seo/off-page', img: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=560&h=340&fit=crop&q=80' },
      { title: 'Local SEO', description: 'Dominate local search and Google Maps results.', tag: 'Local', href: '/services/seo/local-seo', img: 'https://images.unsplash.com/photo-1524661135-423995f22d0b?w=560&h=340&fit=crop&q=80' },
      { title: 'E-commerce SEO', description: 'Optimise product and category pages for buyer intent keywords.', tag: 'E-commerce', href: '/services/seo/ecommerce-seo', img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=560&h=340&fit=crop&q=80' },
      { title: 'YouTube SEO', description: 'Rank your videos on YouTube and Google search.', tag: 'YouTube', href: '/services/seo/youtube-seo', img: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=560&h=340&fit=crop&q=80' },
    ],
    faqs: [
  ...
  'graphics-design': {
    ...
    coverflow: [
      { title: 'Graphic Design', description: 'All print and digital design needs handled by our team.', tag: 'Design', href: '/services/graphics-design/graphic-design', img: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=560&h=340&fit=crop&q=80' },
      { title: 'UI/UX Design', description: 'Interfaces that are beautiful, intuitive, and conversion-optimised.', tag: 'UI/UX', href: '/services/graphics-design/ui-ux', img: 'https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?w=560&h=340&fit=crop&q=80' },
      { title: 'Motion Graphics', description: 'Animated content that gets shared and remembered.', tag: 'Motion', href: '/services/graphics-design/motion', img: 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=560&h=340&fit=crop&q=80' },
      { title: 'Print Design', description: 'Professional print materials that make the right impression.', tag: 'Print', href: '/services/graphics-design/print', img: 'https://images.unsplash.com/photo-1524678714210-9917a6c619c2?w=560&h=340&fit=crop&q=80' },
      { title: 'Social Creatives', description: 'Platform-native creatives that drive engagement and clicks.', tag: 'Social', href: '/services/graphics-design/social-creatives', img: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=560&h=340&fit=crop&q=80' },
      { title: 'Presentation Design', description: 'Stunning decks that help you win deals and close funding.', tag: 'Presentation', href: '/services/graphics-design/presentation', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=560&h=340&fit=crop&q=80' },
    ],
    faqs: [
  ...
  'it-services': {
    ...
    coverflow: [
      { title: 'WordPress', description: 'Custom WordPress sites, themes, and WooCommerce stores.', tag: 'CMS', href: '/services/it-services/wordpress', img: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=560&h=340&fit=crop&q=80' },
      { title: 'Shopify', description: 'High-converting ecommerce stores on the world\'s best platform.', tag: 'E-commerce', href: '/services/it-services/shopify', img: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=560&h=340&fit=crop&q=80' },
      { title: 'React & Next.js', description: 'Blazing-fast web apps with server-side rendering and SEO.', tag: 'Frontend', href: '/services/it-services/react-nextjs', img: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=560&h=340&fit=crop&q=80' },
      { title: 'PHP / Laravel', description: 'Scalable backend systems for complex business logic.', tag: 'Backend', href: '/services/it-services/laravel', img: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?w=560&h=340&fit=crop&q=80' },
      { title: 'Webflow / Wix', description: 'No-code to low-code solutions for rapid launches.', tag: 'No-Code', href: '/services/it-services/webflow-wix', img: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=560&h=340&fit=crop&q=80' },
      { title: 'Web Apps & SaaS', description: 'Full-stack SaaS products built for scale.', tag: 'SaaS', href: '/services/it-services/web-apps', img: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?w=560&h=340&fit=crop&q=80' },
      { title: 'Landing Pages', description: 'Conversion-optimised landing pages that turn clicks into leads.', tag: 'CRO', href: '/services/it-services/landing-pages', img: 'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?w=560&h=340&fit=crop&q=80' },
      { title: 'AI & Automation', description: 'AI-powered tools, chatbots, and business process automation.', tag: 'AI', href: '/services/it-services/ai-automation', img: 'https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=560&h=340&fit=crop&q=80' },
    ],
    faqs: [
  ...
  'social-media': {
    ...
    coverflow: [
      { title: 'Instagram Management', description: 'Aesthetic feeds, reels, and stories that grow your following.', tag: 'Instagram', href: '/services/social-media', img: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=560&h=340&fit=crop&q=80' },
      { title: 'Facebook Management', description: 'Page management, content, and community engagement on Facebook.', tag: 'Facebook', href: '/services/social-media', img: 'https://images.unsplash.com/photo-1611944212129-29977ae1398c?w=560&h=340&fit=crop&q=80' },
      { title: 'LinkedIn Marketing', description: 'B2B-focused content and thought leadership on LinkedIn.', tag: 'LinkedIn', href: '/services/social-media', img: 'https://images.unsplash.com/photo-1616469829581-73993eb86b02?w=560&h=340&fit=crop&q=80' },
      { title: 'Content Creation', description: 'Graphics, reels, carousels, and copy for all platforms.', tag: 'Content', href: '/services/social-media', img: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=560&h=340&fit=crop&q=80' },
      { title: 'Community Management', description: '24/7 engagement with your audience across all platforms.', tag: 'Community', href: '/services/social-media', img: 'https://images.unsplash.com/photo-1556157382-97eda2d62296?w=560&h=340&fit=crop&q=80' },
      { title: 'Influencer Outreach', description: 'Connect with relevant creators for authentic partnerships.', tag: 'Influencer', href: '/services/social-media', img: 'https://images.unsplash.com/photo-1551836022-deb4988cc6d0?w=560&h=340&fit=crop&q=80' },
    ],
    faqs: [
